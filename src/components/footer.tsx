export default function Footer() {
  return (
    <footer className="w-full bg-bg text-text pt-14 pb-6 mt-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-text/80">
            ...
            <li><a href="#" className="hover:text-primary transition">Offers & Deals</a></li>
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4 text-primary">Customer Care</h3>
          <ul className="space-y-2 text-text/80">
        ...
        <div>
          ...
          <p className="text-text/80 mb-4">Subscribe to get updates on new arrivals & special offers.</p>

          <form className="flex gap-2">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-4 py-3 rounded-xl bg-text text-text outline-none focus:ring-2 focus:ring-primary"
            />
            <button
              type="submit"
              className="px-5 py-3 bg-primary text-text font-semibold rounded-xl hover:bg-primary/90 transition"
            >
              Join
            </button>
          </form>
      ...
      {/* Bottom Bar */}
      <div className="mt-12 border-t border-text/20 pt-4 text-center text-text/80 text-sm">
